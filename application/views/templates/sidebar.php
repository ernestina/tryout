    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a href="<?php echo base_url().'pages/view/paket';?>" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Paket Soal</span></a>
                </li>
                <li>
                    <a href="<?php echo base_url().'pages/view/rank';?>" aria-expanded="false"><i class="mdi mdi-format-list-numbers"></i><span class="hide-menu">Rangking<span class="label label-rounded label-warning">Premium</span></span></span></a>
                </li>
                <!--li>
...
<!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <?php
                    //include ('breadcrumb-rightbar.php');
                ?>
                <!-- ============================================================== -->
