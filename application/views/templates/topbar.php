...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <a class="navbar-brand" href="<?php echo base_url().'';?>">
        ...
        <span>
         ...
         <!--img src="../assets/images/logo-text.png" alt="homepage" class="dark-logo" /-->
            <b alt="homepage" class="dark-logo"><?php echo $title; ?></b>
         <!-- Light Logo text -->    
    ...
    <ul class="navbar-nav my-lg-0">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hanna Gover <img src="<?php echo base_url().'assets/images/users/5.jpg';?>" alt="user" class="profile-pic" /></a>
